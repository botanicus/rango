...
describe Rango::Authentication::Errors do

  before(:each) do
    @errors = Rango::Authentication::Errors.new
  end
  ...
  it "should provide an errors instance method on the Authenticaiton instance" do
    a = Rango::Authentication.new(Rango::CookieSession.generate)
    a.errors.should be_a_kind_of(Rango::Authentication::Errors)
  end
