class Rango
  module Session
    ...
    #
    def authentication
      @authentication ||= Rango::Authentication.new(self)
    end
    ...
    #
    # See Rango::Authentication#authenticate for usage
    ...
    # Rango::Authentication#store_user should know how to store the object into the session
    def user=(the_user)
