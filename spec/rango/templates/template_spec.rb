...
describe Rango::Templates::Template do
  describe "#initialize" do
    it "should take path as a first argument" do
      template = Rango::Templates::Template.new("test.html")
      template.path.should eql("test.html")
    end

    it "should take context as an optional second argument" do
      context  = Object.new
      template = Rango::Templates::Template.new("test.html", context)
  ...
  describe "#render" do
    it "should raise TemplateNotFound if template can't be found" do
      template = Rango::Templates::Template.new("idonotexist.html")
    ...
    it "should have template inheritance" do
      template = Rango::Templates::Template.new("inheritance/basic/index.html")
    end

    it "should capture haml" do
      template = Rango::Templates::Template.new("inheritance/capture/haml/index.html")
      template.render
      template.blocks[:content].should match("Hello!")
    end

    it "should capture erubis" do
      template = Rango::Templates::Template.new("inheritance/capture/erubis/index.html")
      template.render
      template.blocks[:content].should match("Hello!")
    end
    ...
    it "should capture erb" do
      ...
      template = Rango::Templates::Template.new("inheritance/capture/erb/index.html")
      template.render
      template.blocks[:content].should match("Hello!")
    end
  end
  ...
  describe "variables" do
    before(:each) do
      @template = Rango::Templates::Template.new("variables.html")
    end
    ...
    it "should <%= &block %>" do
      ...
      template = Rango::Templates::Template.new("erubis.html")
